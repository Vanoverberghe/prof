...
class Labyrinthe:
    ...
    def casser_mur(self, cellule1, cellule2):
        ...
        """
        self.graphe[cellule1].append(cellule2)
        self.graphe[cellule2].append(cellule1)
    ...
    def profondeur_cycle(self, depart, parent, visites):
        ...
        for voisin in self.graphe[depart]:
            if not visites[voisin]:
                if self.profondeur_cycle(voisin, depart, visites):
                    return True
            elif voisin != parent:
                return True
        return False
    ...
    def est_cyclique(self):
        ...
        for cellule in self.cellules:
            if not visites[cellule]:
                if self.profondeur_cycle(cellule, -1, visites):
                    return True
    ...
    def chemin_largeur(self, depart):
        ...
        Pour garder en mémoire le chemin pour le retrouver, on utilise un dictionnaire qui à chaque voisin non visité
...
laby2 = Labyrinthe(5)
murs2 = [(0,5),(5,10),(10,11),(11,16),(16,15),(16,17),(17,18),(18,19),(11,6),(6,1),(1,2),(1,3),(3,8),(8,13),(13,18),(22,23),(12,7),(4,9),(9,14),(14,19),(20,21),(21,22),(23,24)]
